    ...
    <div
        ...
        <div
            ...
            <input type="text" id="table-search-input" placeholder="Search"
                class="w-full pl-10 pr-4 py-3 sm:py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 transition-colors shadow-sm text-sm sm:text-base">
        </div>
    </div>
