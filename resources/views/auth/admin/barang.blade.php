...
<main class="px-8 py-6">
    ...
    <div class="md:hidden fab fixed bottom-6 right-6 flex flex-col items-end gap-3 z-40">
        <button onclick="openModal('modalMasuk')" class="w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-all bg-[#1e5bb5] text-white hover:bg-blue-800">
    ...
    <div id="modalMasuk" class="fixed inset-0 bg-black bg-opacity-30 hidden flex justify-center items-center z-50 p-4 transition-opacity duration-300">
        <div class="modal-bg rounded-lg shadow-lg w-full max-w-2xl relative">
            <div class="flex justify-between items-start p-6 pb-2">
                ...
                <button onclick="closeModal('modalMasuk')" class="absolute top-4 right-4 text-gray-800 hover:text-red-600 text-3xl font-light">
                    &times;
                </button>
            </div>
            <form id="formBarangMasuk" onsubmit="submitBarangMasuk(event)">
                <div class="p-8 pt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <input type="number" name="jumlah_pack" id="jumlah_pack" placeholder="Jumlah Pack" class="input-field placeholder-gray-500" required>
                        </div>
                        <div>
                        ...
                        <div>
                            <input type="number" name="jumlah_pcs" id="jumlah_pcs" placeholder="Jumlah Pcs" class="input-field placeholder-gray-500" required>
                        </div>
                    </div>
    ...
    <div id="modalKeluar" class="fixed inset-0 bg-black bg-opacity-30 hidden flex justify-center items-center z-50 p-4 transition-opacity duration-300">
        <div class="modal-bg rounded-lg shadow-lg w-full max-w-2xl relative">
            <div class="flex justify-between items-start p-6 pb-2">
                <button onclick="closeModal('modalKeluar')" class="absolute top-4 right-4 text-gray-800 hover:text-red-600 text-3xl font-light">
                    &times;
                </button>
            </div>
                ...
                <div class="p-8 pt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative">
                            ...
                            <input type="text" id="search_barang_keluar" placeholder="Ketik Nama Barang..." class="input-field placeholder-gray-500" autocomplete="off">
                        ...
                        <div>
                            <input type="number" name="jumlah_pcs" id="jumlah_pcs_keluar" placeholder="Jumlah Pcs" class="input-field placeholder-gray-500" required>
                        </div>
                    </div>
                    <div class="mb-10"></div>
    ...
    <div id="modalEdit" class="fixed inset-0 bg-black bg-opacity-30 hidden flex justify-center items-center z-50 p-4 transition-opacity duration-300">
        <div class="modal-bg rounded-lg shadow-lg w-full max-w-2xl relative">
            <div class="flex justify-between items-start p-6 pb-2">
                <button onclick="closeModal('modalEdit')" class="absolute top-4 right-4 text-gray-800 hover:text-red-600 text-3xl font-light">
                    &times;
                </button>
            </div>
            <form id="formBarangEdit" onsubmit="submitBarangEdit(event)">
                ...
                <div class="p-8 pt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <input type="text" name="nama_barang" id="edit_nama_barang" placeholder="Nama Barang..." class="input-field placeholder-gray-500" required>
                        </div>
                        <div>
                            <input type="number" name="jumlah_pack" id="edit_jumlah_pack" placeholder="Jumlah Pack" class="input-field placeholder-gray-500" required>
                        </div>
                        <div>
                        ...
                        <div>
                            <input type="number" name="jumlah_pcs" id="edit_jumlah_pcs" placeholder="Jumlah Pcs" class="input-field placeholder-gray-500" required>
                        </div>
                    </div>
                    <div class="flex justify-end gap-3 mt-10">
                        <button type="submit" class="btn-modal-action text-blue-500 border-blue-400 hover:bg-blue-50">
