...
<!-- Modal Edit User -->
<div id="modalEdit" class="fixed inset-0 bg-black bg-opacity-30 hidden flex justify-center items-center z-50 p-4">
    <div class="modal-bg rounded-lg shadow-lg w-full max-w-2xl relative">
        <button onclick="closeModal('modalEdit')" class="absolute top-4 right-4 text-3xl font-light hover:text-red-600">&times;</button>
